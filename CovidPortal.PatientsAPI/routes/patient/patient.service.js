...
function createPatient(patientParam) {
    return __awaiter(this, void 0, void 0, function () {
        var result, patient, doc, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    result.exception = err_1;
                    result.failMessage = err_1.message;
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Patient.find().select("-__v")
                            .then(function (data) {
                            result.hasData = true;
                            result.data = data;
                            return result;
                ...
                case 3:
                    err_2 = _a.sent();
                    result.hasData = false;
                    result.exception = err_2;
                    result.failMessage = err_2.message;
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/, result];
            }
        });
